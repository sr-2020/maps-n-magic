              ...
              <div className="App tw-flex tw-flex-col tw-h-screen">
                ...
                <main className="tw-flex-auto tw-h-full tw-overflow-hidden">
                  <Switch>
                    ...
                    <Route path="/spiritFractionEditor">
                      <SpiritFractionEditor gameModel={gameModel} />
                    </Route>
                    <Route path="/spiritRouteEditor">
                      <SpiritRouteEditor gameModel={gameModel} />
                    </Route>
                    <Route path="/spiritPhraseEditor">
                      <SpiritPhraseEditor gameModel={gameModel} />
                    </Route>
                    <Route path="/spiritOverview">
                      <SpiritOverview gameModel={gameModel} />
                    </Route>
                    ...
                    <Route path="/orgCatchSpirit">
                      <OrgSpiritCatch />
                    </Route>
                    <Route path="/characterLogs">
                      <CharacterLogs />
                    </Route>
